...
{
    /// <inheritdoc />
    public partial class BlueWavesMigrations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Destination = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Delai = table.Column<int>(type: "int", nullable: false),
                    ExportNumeroExport = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_COMMANDE_EXPORT_ExportNumeroExport",
                        column: x => x.ExportNumeroExport,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_COMMANDE_ExportNumeroExport",
                table: "COMMANDE",
                column: "ExportNumeroExport");
